...
translations = {
    'ky': {
        ...
        "Stage IDs for Project Entity, you can find this by clicking inspect on the columns": "Долбоорлор үчүн этап IDлерин колонкаларды «Inspect» басып таба аласыз",
    ...
    'ru': {
        ...
        "Stage IDs for Project Entity, you can find this by clicking inspect on the columns": "Идентификаторы стадий для сущности Проектов можно найти, нажав «Инспектировать» на колонках",
